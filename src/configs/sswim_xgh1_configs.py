...
def get_config(dataset_name, N_warplayers=None, ):
    ...
    if N_warplayers is None:
        config["N_warplayers"] = 1  # Standard RFF. No warping!
    else:
    ...
    # config["optim_kwargs"] = {"lr": 0.12, "betas": (0.1, 0.1)}
