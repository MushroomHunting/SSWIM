...
N_repeats = 10
N_pseudo_ = [5, 10, 20, 40, 80, 160, 320, 640, 1280, 2560]
sswim_type = "xgh"
N_warplayers = 1
        ...
        for key in all_datasets.keys():
            ...
            for experiment_id in trange(N_repeats):
                try:
                    ...
                    result_filepath = os.path.join(log_path, f"{dataset_name}_sswim{N_warplayers}_epochs{cfg['optim_epochs']}_pseudo{N_pseudo}.csv")
